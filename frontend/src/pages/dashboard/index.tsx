      ...
      <div style={{ height: '100vh', background: 'var(--deep)', display: 'flex', flexDirection: 'column', overflow: 'hidden', position: 'relative' }}>
        ...
        <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{
            ...
            filter: trackerOpen ? 'blur(1.5px) brightness(0.55) saturate(0.7)' : 'blur(0px) brightness(1) saturate(1)',
            opacity: trackerOpen ? 0.75 : 1,
          }}>
          ...
          <div style={{
            ...
            <div className="fd2" style={{ display: 'flex', flexDirection: 'column', gap: '1rem', width: '100%', maxWidth: 560 }}>
              ...
              {/* UPLOAD */}
              <button className="action-btn btn-upload" onClick={() => setUploadOpen(true)} style={{
